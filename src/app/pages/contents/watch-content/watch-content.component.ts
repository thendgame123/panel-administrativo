...
export class WatchContent {
  ...
  private initForm(): void {
    this.contentForm = this.fb.group({
      ...
      htmlContent: [{value:'', disabled: true}],
      layoutPosition: [{value:'', disabled: true}],
      vigenciaActiva: [{value:'', disabled: true}],
      fechaInicio: [{value:'', disabled: true}],
      fechaFin: [{value:'', disabled: true}],
      videoUrl: [{value:'', disabled: true}],
      pdfUrl: [{value:'', disabled: true}],
      isActive: [{value:true, disabled: true}],
      isScreensaver: [{value:true, disabled: true}],
    });
  }
  //TODO: PASAR INFORMACIÓN DEL PDF
  /**
  ...
  /**
   * Maneja el cambio de selección de embarcaciones
   */
  ...
  async onSubmit(): Promise<void> {
    ...
    await this.updateContent(uploadedImageUrl);
  }
   ...
   */
  private async updateContent(imageUrl: string): Promise<void> {
    const contentData = {
      id: this.contentId,
   ...
   */
  onCancel(): void {
    if (this.contentForm.dirty || this.selectedImageFile || this.selectedVideoFile) {
